# Chapitre 5 — Equipment (pages 46–50)
...
## 5.1 — LOOT REWARDS (p.46)

> Page 46 = illustration pleine page (personnage avec sac médical "HEAL"). Aucun contenu textuel de règles.

---

## 5.2 — ITEM LIST & EQUIPMENT TABLE (p.47–48)

### Items (p.47)

> Roll sur cette table pour les items trouvés en exploration ou en loot.
...
> Roll sur cette table quand un **Armor Tag** aléatoire est trouvé.
